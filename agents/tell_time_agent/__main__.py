...
@click.option('--port', 'port', default=10002)            # Port where the agent will listen (default: 10000)
def main(host: str, port: int):
    """
    Launches the TellTimeAgent A2A server.
    ...
    print(f"\n🚀 Starting TellTimeAgent on http://{host}:{port}/\n")
