# =============================================================================
# agents/greeting_agent/agent_executor.py
# =============================================================================
# Purpose:
# This file defines the "executor" that acts as a bridge between the A2A server
# and the underlying Greeting agent. It listens to tasks and dispatches them to
...
from .agent import GreetingAgent  # Imports the GreetingAgent class from the same directory
...
# -----------------------------------------------------------------------------
# GreetingAgentExecutor: Connects the agent logic to A2A server infrastructure
# -----------------------------------------------------------------------------

class GreetingAgentExecutor(AgentExecutor):  # Define a new executor by extending A2A's AgentExecutor
    """
    This class connects the GreetingAgent to the A2A server runtime. It implements
    ...
    def __init__(self):  # Constructor for the executor class
        self.agent = GreetingAgent()  # Creates an instance of the GreetingAgent for handling queries
